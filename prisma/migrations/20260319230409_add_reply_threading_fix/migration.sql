...
INSERT INTO "new_RatingReply" ("anonId", "createdAt", "id", "parentReplyId", "ratingId", "text", "updatedAt", "userId") SELECT "anonId", "createdAt", "id", "parentReplyId", "ratingId", "text", "updatedAt", "userId" FROM "RatingReply";
