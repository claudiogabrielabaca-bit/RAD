        ...
        <div className="relative p-8 sm:p-10 lg:p-12">
          <div className="max-w-4xl">
            ...
            <p className="mt-5 max-w-3xl text-base leading-8 text-zinc-300 sm:text-[1.18rem]">
              ...
              choose an exact date to explore births, deaths, and key historical
              events.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            <button
              ...
              className="group rounded-[28px] border border-white/8 bg-white/[0.05] px-6 py-6 text-left backdrop-blur-xl transition hover:border-white/12 hover:bg-white/[0.08]"
            >
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="h-12 rounded-2xl bg-white px-6 text-base font-semibold text-black transition hover:bg-zinc-200"
                >
                  Go
                </button>
